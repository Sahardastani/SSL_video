...
from src.utils.svt.data_utils import get_random_sampling_rate, tensor_normalize, spatial_sampling, pack_pathway_output
from src.datasets.svt.decoder import decode
...
class UCF101(torch.utils.data.Dataset):
    ...
    def _construct_loader(self):
        ...
        path_to_file = os.path.join(
            self.cfg.TESTsvt.PATH_TO_DATA_DIR, "ucf101_{}_split_1_videos.txt".format(self.mode)
        )
            ...
            for clip_idx, path_label in enumerate(f.read().splitlines()):
                ...
                for idx in range(self._num_clips):
                    self._path_to_videos.append(
                        os.path.join(self.cfg.TESTsvt.PATH_PREFIX, path)
                    )
    ...
    def __getitem__(self, index):
        ...
        sampling_rate = get_random_sampling_rate(
            ...
            self.cfg.TESTsvt.SAMPLING_RATE,
        )
        ...
        for i_try in range(self._num_retries):
            ...
            try:
                video_container = get_video_container(
                    ...
                    self.cfg.TESTsvt.ENABLE_MULTI_THREAD_DECODE,
