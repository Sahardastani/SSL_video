...
import models.resnet_vicregl as resnet_models
from models.feature_extractor import FeatureExtractor_swav
...
new_model = FeatureExtractor_swav(model.to(device)).to(device)
